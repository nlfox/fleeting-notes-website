    ...
    <div className="flex justify-center mb-10">
        <ul className="inline-flex -space-x-px">
          <li>
            {(currPage === 1) ? (
              <a href={`javascript:void(0)`}
                className="bg-white border border-gray-300 text-gray-500 ml-0 rounded-l-lg leading-tight py-2 px-3 cursor-default">Previous</a>
            ): (
          ...
          <li>
            {(currPage === maxPage) ? (
              <a href={`javascript:void(0)`}
                className={`bg-white border border-gray-300 text-gray-500 rounded-r-lg leading-tight py-2 px-3 cursor-default`}>Next</a>
            ): (
              <a href={`/posts/${currPage + 1}`}
